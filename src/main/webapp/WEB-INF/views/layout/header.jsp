...
<nav id="navbar" class="navbar navbar-expand-sm navbar-dark sticky-top" style="background-color: rgb(206,18,18); border-bottom: 1px solid gainsboro;">
	<div class="container ">
				...
				<div class="input-group">
					<form action="/product/list-by-keywords" method="post">
						...
						<div class="input-group-append">
							<button class="btn btn-secondary" value="${param.keywords}" type="submit" style="background-color: black; border: none; width: 50px; height: 34px">
